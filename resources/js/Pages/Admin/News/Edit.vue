...
const photoPreview = ref(props.news.photo_url || null);
    ...
    <AdminOrganizerLayout>
        <div class="py-8 bg-gray-50 min-h-screen">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Header -->
                <div class="mb-8">
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Редактировать новость</h1>
                    <p class="text-lg text-gray-600">Измените данные новости</p>
                </div>
                    ...
                    <form @submit.prevent="submit" class="space-y-8">
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            <button
                                type="button"
                                @click="deleteNews"
                                class="inline-flex items-center gap-2 px-6 py-3 bg-red-600 hover:bg-red-700 text-white rounded-xl font-medium transition-all duration-200 shadow-sm hover:shadow-md border border-red-600/20"
                            >
