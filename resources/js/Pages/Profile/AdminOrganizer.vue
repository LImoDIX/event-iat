...
import AdminOrganizerProfilePhotoForm from './Partials/AdminOrganizerProfilePhotoForm.vue';
...
defineProps({
    ...
    updateRoute: {
        type: String,
        default: 'profile.admin-organizer.update'
    }
});
                                        ...
                                        <div class="mt-8 w-full">
                                            <nav class="space-y-2">
                                                ...
                                                >
                                                    ...
                                                    <span class="font-medium">Фото профиля</span>
                                                </button>
                                            </nav>
                                        </div>
                                    </div>
                            ...
                            <div class="lg:col-span-3">
                                ...
                                <div v-show="activeTab === 'profile'" class="bg-white border border-gray-200 rounded-2xl p-8 transition-all duration-300">
                                    <div class="flex items-center gap-4 mb-6">
                                        ...
                                        <div>
                                            <h2 class="text-2xl font-bold text-gray-900">Фото профиля</h2>
                                            <p class="text-gray-600 mt-1">
                                                Обновите фото вашего профиля
                                            </p>
                                        </div>
                                    </div>
                                    <AdminOrganizerProfilePhotoForm
